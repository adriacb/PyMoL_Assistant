...
from pymolassistant.models import *
from pymolassistant.dag.tools import *
from pymolassistant.dag.states import *
from pymolassistant.dag.llm import model
...
async def call_model(state) -> dict:
    ...
    # if len(messages) == 1:                          # Diabled for now
